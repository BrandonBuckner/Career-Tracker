function JobDetail({ activeView, selectedJob, setSelectedJob, getStatusBadge, formatDate }) {
    return (
        <div className="container-fluid">
            <button className="btn btn-outline-secondary mb-3" onClick={() => setSelectedJob(null)}>
